...
class HiddenWordBuilder {
    ...
    buildSimbolBox(insertedText, input) {
        ...
        document.body.style.backgroundImage = `url("./app/assets/images/background_game.gif")`;
    }
        ...
        let exitButton = document.querySelector('.exit-button'),
            ...
            exitListener = (event) => {
                if (confirm('Are you shure ?')) {
                    ...
                    document.body.style.backgroundImage = `url("./app/assets/images/background_main.gif")`;
                }
            },
...
},{"../config/signsConfig.js":3,"gsap":5}],3:[function(require,module,exports){
'use strict';
...
},{"./MainApp.js":1,"howler":6}],5:[function(require,module,exports){
(function (global){
/*!
 * VERSION: 1.20.5
 * DATE: 2018-05-21
